# 📇 Agenda de Contatos (Windows Forms)

<div align="center">
    <img src="Captura de tela 2026-04-27 001636.png" alt="Screenshot da Agenda de Contatos" width="500" height="800" style="object-fit: cover;">
</div>

<header>
    <p>Uma aplicação desktop simples e eficiente desenvolvida em <strong>C#</strong> para gerenciamento de contatos. O sistema permite adicionar, remover e persistir dados em um arquivo de texto local.</p>
</header>
...
<footer>
    <hr>
    <p align="center"><em>Nota: Este projeto foi desenvolvido para fins de aprendizado sobre manipulação de arquivos e listas em C#.</em></p>
</footer>